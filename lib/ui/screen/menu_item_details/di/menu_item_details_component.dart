...
class MenuItemDetailsComponent extends WidgetComponent {
  MenuItemDetailsComponent(BuildContext context) : super(context) {
...
MenuItemDetailsWidgetModel createMenuItemDetailsWidgetModel(
  BuildContext context, {
  @required List<CategoryItem> listCategoryItem,
  @required MenuItem menuItem,
}) {
  final component = Injector.of<MenuItemDetailsComponent>(context).component;
  return MenuItemDetailsWidgetModel(
