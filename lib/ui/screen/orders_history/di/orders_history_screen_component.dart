...
import '../orders_history_screen_wm.dart';

/// [Component] для <OrdersHistoryScreen>
class OrdersHistoryScreenComponent implements Component {
  OrdersHistoryScreenComponent(BuildContext context) {
...
OrdersHistoryScreenWidgetModel createOrdersHistoryScreenWidgetModel(
  BuildContext context,
) {
  final component =
      Injector.of<OrdersHistoryScreenComponent>(context).component;

  return OrdersHistoryScreenWidgetModel(component.wmDependencies);
}
