...
/// [Component] для <ThanksScreen>
class ThanksScreenComponent implements Component {
  ThanksScreenComponent(BuildContext context) {
...
ThanksScreenWidgetModel createThanksScreenWidgetModel(BuildContext context) {
  final component = Injector.of<ThanksScreenComponent>(context).component;

  return ThanksScreenWidgetModel(
